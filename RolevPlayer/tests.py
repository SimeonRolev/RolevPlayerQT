...
class TestLibraryLoader(unittest.TestCase):
    ...
    def setUp(self):
        self.library = {}
        self.song1 = LibraryLoader.create_song("../../TestMusic/02 - Tragic Magic.mp3")
        self.song2 = LibraryLoader.create_song("../../TestMusic/03 - The Drug In Me is You.mp3")
    ...
    def test_create_song(self):
        ...
        self.assertEqual(self.song2.path, "../../TestMusic/03 - The Drug In Me is You.mp3")
    ...
    def test_add_song_to_dict(self):
        ...
        self.assertIn(('Tragic Magic', '../../TestMusic/02 - Tragic Magic.mp3'), self.library['Falling in Reverse']['The Drug in Me Is You'])
        self.assertNotIn(('The Drug In Me is You', '../../TestMusic/03 - The Drug In Me is You.mp3'), self.library['Falling in Reverse']['The Drug in Me Is You'])

    def test_load_music_from_dir(self):
        test = LibraryLoader.load_music_from_dir("../../TestMusic")
        ...
        self.assertEqual(13, len(test['Falling in Reverse']['The Drug in Me Is You']))
